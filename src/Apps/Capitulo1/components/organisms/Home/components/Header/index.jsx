...
import { AddIcon, ArrowIcon } from '@/Apps/Capitulo1/assets/Icons'
        ...
        <div className={style.root_header}>
            <div className={style.root_header_main}>
                ...
                <span className="flex items-center space-x-4">
                    <div onClick={handleMode} id="dashboard" className={`${style.item_mode} ${props.mode() == "dashboard" ? "active" : ""}`}>Grade</div>
